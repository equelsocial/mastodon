...
const SignInBanner = () => {
  return (
    <div className='sign-in-banner'>
      ...
      <a href='/auth/auth/openid_connect' className='button button--block button-with-icon'>
        <Icon id="linkedin" fixedWidth aria-hidden='true' />
        <FormattedMessage id='sign_in_banner.sign_in' defaultMessage='Log in' />
      </a>
      <a href='/auth/auth/openid_connect' className='button button--block button-tertiary button-with-icon'>
        <Icon id="linkedin" fixedWidth aria-hidden='true' />
