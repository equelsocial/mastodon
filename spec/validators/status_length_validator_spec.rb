...
describe StatusLengthValidator do
  describe '#validate' do
    ...
    it 'does not count non-autolinkable URLs as 23 characters flat' do
      text   = ('a' * 3000) + "http://#{'b' * 30}.com/example"
      status = status_double(text: text)
